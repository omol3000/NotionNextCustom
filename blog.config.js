...
const BLOG = {
  ...
  'de-DE:02ab3b8678004aa69e9e415905ef32a5,en:7c1d570661754c8fbc568e00a01fd70e',
  THEME: process.env.NEXT_PUBLIC_THEME || 'nobelst', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  LANG: process.env.NEXT_PUBLIC_LANG || 'de-DE', // e.g 'zh-CN','en-US'  see /lib/lang.js for more.
  SINCE: process.env.NEXT_PUBLIC_SINCE || 2025, // e.g if leave this empty, current year will be used.
  WIDGET_PET: process.env.NEXT_PUBLIC_WIDGET_PET || false, // 宠物挂件，支持的宠物见 /components/WidgetPet/index.js
  PSEUDO_STATIC: process.env.NEXT_PUBLIC_PSEUDO_STATIC || false, // 伪静态路径，开启后所有文章URL都以 .html 结尾。
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 21600, // 更新缓存间隔 单位(秒)；即每个页面有该时长的纯静态期、此期间无论多少次访问都不会抓取notion数据；调大该值有助于节省Vercel资源、同时提升访问速率，但也会使文章更新有延迟。
  ...
  // Optional: override author avatar image. If set, this will be used instead of Gravatar.
  AUTHOR_IMAGE: process.env.NEXT_PUBLIC_AUTHOR_IMAGE || '/avatar.png',
