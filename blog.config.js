...
const BLOG = {
  ...
  // AUTHOR_IMAGE: Path or URL to the author's profile image. Put image in /public and use '/images/me.jpg',
  // or set NEXT_PUBLIC_AUTHOR_IMAGE in your environment for production (Vercel). Falls back to null in code.
  AUTHOR_IMAGE: process.env.NEXT_PUBLIC_AUTHOR_IMAGE || '/images/author.jpg',
