...
module.exports = {
  ...
  SPEED_INSIGHTS_VERCEL: process.env.NEXT_PUBLIC_SPEED_INSIGHTS_VERCEL || true, // Vercel Speed Insights，采集真实访客的 Core Web Vitals https://vercel.com/docs/speed-insights
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-ZV6E0M26E3', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
